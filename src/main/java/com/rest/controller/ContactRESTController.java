...
public class ContactRESTController {
    ...
    public ContactRESTController(Validator validator) {
    ...
    @AccessCheck
    @RolesAllowed({"USER"})
    public Response getContactByName(@PathParam("uid") Integer userId,@QueryParam("firstname") Optional<String> firstname,@QueryParam("lastname") Optional<String> lastname,@Auth User user) {
    ...
    @AccessCheck
    @RolesAllowed({"USER"})
    public Response createContact(@PathParam("uid") Integer userId, Contact contact,@Auth User user) throws URISyntaxException {
        // validation
    ...
    @AccessCheck
    @RolesAllowed({"USER"})
    public Response removeContactById(@PathParam("uid") Integer userId, @QueryParam("contactId") Integer contactId,@Auth User user) {
